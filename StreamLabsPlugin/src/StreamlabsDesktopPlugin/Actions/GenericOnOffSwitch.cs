namespace Loupedeck.StreamlabsPlugin.Actions
{
    ...
    public abstract class GenericOnOffSwitch : PluginTwoStateDynamicCommand
    {
        ...
        {
            this.Name = name;
            this.OnStateImage = EmbeddedResources.ReadBinaryFile(StreamlabsPlugin.ImageResPrefix + onStateImage);
            this.OffStateImage = EmbeddedResources.ReadBinaryFile(StreamlabsPlugin.ImageResPrefix + offStateImage);
