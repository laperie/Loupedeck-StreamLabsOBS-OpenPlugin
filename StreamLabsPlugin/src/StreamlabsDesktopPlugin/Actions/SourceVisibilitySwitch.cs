namespace Loupedeck.StreamlabsPlugin.Actions
{
    ...
    internal class SourceVisibilitySwitch : ActionEditorCommand
    {
        ...
        private void OnActionEditorListboxItemsRequested(Object sender, ActionEditorListboxItemsRequestedEventArgs e)
        {
             ...
             * e.ActionEditorState.SetEnabled(ControlSceneSelector, StreamlabsPlugin.Proxy.IsAppConnected);
             * e.ActionEditorState.SetEnabled(ControlSourceSelector, StreamlabsPlugin.Proxy.IsAppConnected);
             * e.ActionEditorState.SetEnabled(ControlIsSourceVisible, StreamlabsPlugin.Proxy.IsAppConnected);
            */
            ...
            {
                if (!StreamlabsPlugin.Proxy.IsAppConnected)
                {
                ...
                else
                {
                    ...
                    foreach (var item in StreamlabsPlugin.Proxy.ScenesWithItems)
                    {
            ...
            else if (e.ControlName.EqualsNoCase(ControlSourceSelector))
            {
                ...
                if (!String.IsNullOrEmpty(selectedScene))
                {
                    ...
                    if (StreamlabsPlugin.Proxy.ScenesWithItems.TryGetValue(selectedScene, out var sceneItemList))
                    {
                        var firstKey = "";
        ...
        protected override BitmapImage GetCommandImage(ActionEditorActionParameters actionParameters, Int32 imageWidth, Int32 imageHeight)
        {
            ...
            return (this.Plugin as StreamlabsPlugin).GetPluginCommandImage(imageWidth >=80 ? PluginImageSize.Width90: PluginImageSize.Width60, imageName, sourceName, imageName == SourceVisibilityCommand.IMGSceneSelected);
        }
        ...
        protected override Boolean RunCommand(ActionEditorActionParameters actionParameters)
        {
            if (actionParameters.TryGetString(ControlSourceSelector, out var key))
            {
                ...
                StreamlabsPlugin.Proxy.AppSceneItemVisibilityToggle(key, true, setVisible);
