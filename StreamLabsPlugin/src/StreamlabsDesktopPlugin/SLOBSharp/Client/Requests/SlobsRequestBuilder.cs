...
namespace SLOBSharp.Client.Requests
{
    ...
    public interface ISlobsRequestBuilderOptions<TBuilder>
    {
        ...
        /// <summary>
        /// Sets the compactMode field in the request parameters.
        /// </summary>
        /// <param name="resource"></param>
        /// <returns></returns>
        TBuilder SetCompactMode(bool compactMode);
    }
    ...
    public sealed class SlobsMultipleRequestBuilder : ISlobsMultipleRequestBuilder
    {
        ...
        public ISlobsMultipleRequestBuilder SetCompactMode(bool compactMode)
        {
            this.currentRequestBuilder.SetCompactMode(compactMode);
            return this;
        }
    ...
    public sealed class SlobsRequestBuilder : ISlobsRequestBuilder
    {
        ...
        public ISlobsRequestBuilder SetCompactMode(bool compactMode)
        {
            this.currentRequest.Parameters.CompactMode = compactMode;
            return this;
        }
